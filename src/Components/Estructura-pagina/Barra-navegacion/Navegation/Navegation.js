...
function Navegation() {
    //Declaro la variable de estado que comienza en false (cerrada) para luego cambiarle el valor
    ...
    return (<>
        ...
        <nav className={styles['navegador-principal']}>
            ...
            <div className={styles['contenedor-nav-logo']}>
                ...
                <NavLinkItems to="/">
                    ...
                    <div className={styles['logo-texto-contenedor']}>
                        ...
                        <h3 className={styles['letra-logo-cabecera']}>
                            RECO
                        </h3>
            ...
            <div className={`${styles['contenedor-nav-paginas']} ${isOpen ? styles.open : ''}`}>
                ...
                <NavLinkItems to="/servicios" >
                    Servicios
                </NavLinkItems>

                <NavLinkItems to="/nuestros-trabajos" >
                    Nuestros trabajos
                </NavLinkItems>

                <NavLinkItems to="/sobre-nosotros">
                    Sobre nosotros
                </NavLinkItems>

                <NavLinkItems to="/contacto" >
                    Contacto
                </NavLinkItems>
            </div>
